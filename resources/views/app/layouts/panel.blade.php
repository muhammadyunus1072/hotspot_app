...
<html lang="en">
	<!--begin::Head-->
	<head><base href=""/>
		<title>@yield('title', 'Aplikasi Pembayaran dan Management Wi-Fi')</title>
		<meta charset="utf-8" />
		<meta name="description" content="Bayar tagihan Wi-Fi Anda dengan mudah dan cepat menggunakan aplikasi kami. Nikmati kemudahan pembayaran, notifikasi tagihan, dan riwayat transaksi dalam satu aplikasi. Unduh sekarang dan nikmati koneksi internet tanpa hambatan!">
        <meta name="keywords" content="aplikasi pembayaran wifi, bayar wifi online, aplikasi pembayaran tagihan internet, aplikasi bayar wifi, cara bayar wifi mudah, aplikasi tagihan wifi, pembayaran wifi cepat, notifikasi tagihan wifi, riwayat pembayaran wifi, aplikasi tagihan internet">
