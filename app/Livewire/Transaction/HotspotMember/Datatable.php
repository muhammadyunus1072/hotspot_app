...
class Datatable extends Component
{
    ...
    public function onDialogDeleteConfirm()
    {
        ...
        HotspotMemberRepository::delete($this->targetDeleteId);
        ...
        return [
            [
                ...
                'render' => function ($item) {
                    ...
                    $editHtml = "";
                    if ($this->isCanUpdate) {
                        $editUrl = route('hotspot_member.edit', $item->id);
            ...
            [
                'key' => 'products.name',
                'name' => 'Nama Paket Bulanan',
                'render' => function($item)
                {
                    return $item->product_name." - Rp ".NumberFormatter::format($item->product_price);
                }
            ],
        ];
    }
    ...
    {
        return HotspotMemberRepository::datatable();
    }

    public function getView(): string
    {
        return 'livewire.transaction.hotspot-member.datatable';
    }
}
