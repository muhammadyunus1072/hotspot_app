...
class Datatable extends Component
{
    ...
    public function onMount()
    {
        ...
        $this->isCanDelete = $authUser->hasPermissionTo(PermissionHelper::transform(PermissionHelper::ACCESS_MONTHLY_HOTSPOT, PermissionHelper::TYPE_DELETE));
    ...
    {
        return MonthlyHotspotRepository::datatable();
    }
